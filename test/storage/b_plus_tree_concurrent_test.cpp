...
TEST(BPlusTreeConcurrentTest, _InsertTest1) {  // NOLINT
  InsertTest1Call();
}

TEST(BPlusTreeConcurrentTest, _InsertTest2) {  // NOLINT
  InsertTest2Call();
}

TEST(BPlusTreeConcurrentTest, _DeleteTest1) {  // NOLINT
  DeleteTest1Call();
}

TEST(BPlusTreeConcurrentTest, _DeleteTest2) {  // NOLINT
  DeleteTest2Call();
}

TEST(BPlusTreeConcurrentTest, _MixTest1) {  // NOLINT
  MixTest1Call();
}

TEST(BPlusTreeConcurrentTest, _MixTest2) {  // NOLINT
  MixTest2Call();
}
}  // namespace bustub
